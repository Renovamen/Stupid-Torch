...
public class SettingsActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        if(mColor.getValue()==null) mColor.setValueIndex(0);
        ...
        mHide.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener()
        {
            ...
            public boolean onPreferenceClick(Preference preference)
            {
                ...
                mAlertDialog.setNegativeButton(getString(R.string.no), new DialogInterface.OnClickListener()
                {
                    ...
                    {
                        getPackageManager().setComponentEnabledSetting(new ComponentName("com.zou.torch", "com.zou.torch.LaunchActivity"), PackageManager.COMPONENT_ENABLED_STATE_ENABLED, PackageManager.DONT_KILL_APP);
                        dialog.dismiss();
                    }
                });
                mAlertDialog.setPositiveButton(getString(R.string.yes), new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which)
                    {
                        getPackageManager().setComponentEnabledSetting(new ComponentName("com.zou.torch", "com.zou.torch.LaunchActivity"), PackageManager.COMPONENT_ENABLED_STATE_DISABLED, PackageManager.DONT_KILL_APP);
						dialog.dismiss();
...
*/
    ...
    {
        if (key.equals(KEY_SOS)) enablementSOS();
    ...
    {
        if(mSos.isChecked()) enablementSOS();
        if(mScreen.isChecked()) enablementScreen();
    }
    ...
    public void onResume()
    {
        ...
        String mPrefColor = mPreferences.getString(KEY_COLOR, getString(R.string.amber));
    ...
    private void openAboutDialog()
    {
        ...
        mMrDoomy.setColorFilter(getResources().getColor(R.color.blueDark), PorterDuff.Mode.SRC_ATOP);
        mStudio.setColorFilter(getResources().getColor(R.color.blue), PorterDuff.Mode.SRC_ATOP);
